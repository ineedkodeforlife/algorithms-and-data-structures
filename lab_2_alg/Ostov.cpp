...
//	E.push_back(Edge('3', '4', 1));
//	E.push_back(Edge('6', '7', 1));
//	E.push_back(Edge('3', '6', 1));
//	E.push_back(Edge('2', '7', 2));
//	E.push_back(Edge('2', '5', 3));
//	E.push_back(Edge('5', '6', 4));
//	E.push_back(Edge('1', '2', 4));
//	E.push_back(Edge('7', '8', 5));
//	E.push_back(Edge('4', '8', 6));
//	E.push_back(Edge('3', '8', 7));
//	E.push_back(Edge('4', '7', 8));
//	E.push_back(Edge('1', '5', 9));
//	E.push_back(Edge('1', '6', 10));
//
//
//	while (true)
//	{
